...
final class ValueBool extends ValueType {

	public final static ValueBool INSTANCE = new ValueBool();
	...
	void give(Object entity, ODBSMethod method) {
		try {
			method.set().invokeExact(entity, false);
		} catch (Throwable e) {
	...
	<O, I> void read(Object entity, ODBSMethod method, ODBSCodec<O, I> codec, I in) throws IOException {
		final boolean value = codec.readBool(in);
		try {
