...
final class ValueLong extends ValueType {

	public final static ValueLong INSTANCE = new ValueLong();
	...
	void give(Object entity, ODBSMethod method) {
		try {
			method.set().invokeExact(entity, 0L);
		} catch (Throwable e) {
	...
	<O, I> void read(Object entity, ODBSMethod method, ODBSCodec<O, I> codec, I in) throws IOException {
		final long value = codec.readLong(in);
		try {
